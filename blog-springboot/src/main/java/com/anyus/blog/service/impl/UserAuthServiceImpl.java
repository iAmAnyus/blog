...
import com.anyus.blog.constant.MQPrefixConst;
import com.anyus.blog.constant.RedisPrefixConst;
import com.anyus.blog.dao.UserAuthDao;
import com.anyus.blog.dao.UserInfoDao;
import com.anyus.blog.dao.UserRoleDao;
import com.anyus.blog.dto.EmailDTO;
import com.anyus.blog.dto.UserAreaDTO;
import com.anyus.blog.dto.UserBackDTO;
import com.anyus.blog.dto.UserInfoDTO;
import com.anyus.blog.entity.UserAuth;
import com.anyus.blog.entity.UserInfo;
import com.anyus.blog.entity.UserRole;
import com.anyus.blog.enums.LoginTypeEnum;
import com.anyus.blog.enums.RoleEnum;
import com.anyus.blog.exception.BizException;
import com.anyus.blog.service.BlogInfoService;
import com.anyus.blog.service.RedisService;
import com.anyus.blog.service.UserAuthService;
import com.anyus.blog.strategy.context.SocialLoginStrategyContext;
import com.anyus.blog.util.PageUtils;
import com.anyus.blog.util.UserUtils;
import com.anyus.blog.vo.*;
...
import static com.anyus.blog.enums.UserAreaTypeEnum.getUserAreaType;
import static com.anyus.blog.util.CommonUtils.checkEmail;
import static com.anyus.blog.util.CommonUtils.getRandomCode;
